...
NTSTATUS
UsbPerformancePanelQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = UsbPerformancePanelEvtIoDeviceControl;
    queueConfig.EvtIoStop = UsbPerformancePanelEvtIoStop;
...
VOID
UsbPerformancePanelEvtIoDeviceControl(
    _In_ WDFQUEUE Queue,
